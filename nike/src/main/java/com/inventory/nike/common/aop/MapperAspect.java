...
public class MapperAspect {
    ...
    @Pointcut("execution(* com.inventory.nike.common.mapper.MapperCustom.insert(..))")
    public void pointInsertService() {
    }

    @Pointcut("execution(* com.inventory.nike.common.mapper.MapperCustom.update(..))")
    public void pointUpdateService() {
    }

    @Pointcut("execution(* com.inventory.nike.common.mapper.MapperCustom.updateById(..))")
