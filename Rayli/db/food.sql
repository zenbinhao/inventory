...
-- 产品信息表
-- ----------------------------
DROP TABLE IF EXISTS `rayli_food`;
CREATE TABLE `rayli_food`  (
          `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键id',
          `food_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
          `introduce` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '介绍',
          `file_list` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片组路径以分号间隔',
          `now_price` double NOT NULL DEFAULT 0.00 COMMENT '现价(优惠价)',
          `old_price` double NOT NULL DEFAULT 0.00 COMMENT '原价',
...
ALTER TABLE rayli_food COMMENT '产品信息表';
